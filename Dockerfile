...
ARG NEXT_PUBLIC_DOCKER_IMG_TAG
ARG NEXT_PUBLIC_LOG_BUILD_INFO

# Set environment variables for build
ENV NEXT_PUBLIC_HOST_URL=$NEXT_PUBLIC_HOST_URL \
    NEXT_PUBLIC_COMMIT_SHA=$NEXT_PUBLIC_COMMIT_SHA \ 
    NEXT_PUBLIC_BRANCH_NAME=$NEXT_PUBLIC_BRANCH_NAME \
    NEXT_PUBLIC_DOCKER_IMG_TAG=$NEXT_PUBLIC_DOCKER_IMG_TAG \
    NEXT_PUBLIC_LOG_BUILD_INFO=$NEXT_PUBLIC_LOG_BUILD_INFO
