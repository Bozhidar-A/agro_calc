...
export function CalculateChemProtPercentSolution(
...
export function CalculateChemProtWorkingChemicalLiters(
...
export function CalculateChemProtTotalChemicalLiters(
  workingSolutionPerAcreMl: number,
  areaToBeSprayedAcres: number
): number {
  return (workingSolutionPerAcreMl * areaToBeSprayedAcres) / 1000;
}

export function CalculateChemProtTotalWorkingSolutionLiters(
...
export function CalculateChemProtRoughSprayerCount(
  totalWorkingSolutionLiters: number,
  areaToBeSprayedAcres: number,
...
export function CalculateChemProtWorkingSolutionPerSprayerML(
  ...
  return (
    ((chemicalPerAcreML * areaToBeSprayedAcres) /
      (workingSolutionPerAcreLiters * sprayerVolumePerAcreLiters)) *
    100
  );
}
