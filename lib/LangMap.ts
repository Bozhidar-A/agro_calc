...
export const LangMap: LangMapInterface = {
  BG: {
    ...
    [SELECTABLE_STRINGS.LOGOUT_ALL_SESSIONS]: 'Прекрати всички сесии',
    [SELECTABLE_STRINGS.LOGOUT_SESSION]: 'Прекрати сесията',
    [SELECTABLE_STRINGS.SESSION_USER_INFO]: 'Информация за потребителя',
    [SELECTABLE_STRINGS.SESSION_EXPIRES]: 'Изтича',
  ...
  EN: {
    ...
    [SELECTABLE_STRINGS.LOGOUT_ALL_SESSIONS]: 'Logout all sessions',
    [SELECTABLE_STRINGS.LOGOUT_SESSION]: 'Logout this session',
    [SELECTABLE_STRINGS.SESSION_USER_INFO]: 'User Info',
    [SELECTABLE_STRINGS.SESSION_EXPIRES]: 'Expires',
