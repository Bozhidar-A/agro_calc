...
export enum SELECTABLE_STRINGS {
  ...
  CHEM_PROT_WORKING_CALC_TITLE = 'CHEM_PROT_WORKING_CALC_TITLE',
  CHEM_PROT_WORKING_CALC_DESCRIPTION = 'CHEM_PROT_WORKING_CALC_DESCRIPTION',
  CHEM_PROT_WORKING_INPUT_DESCRIPTION = 'CHEM_PROT_WORKING_INPUT_DESCRIPTION',
  CHEM_PROT_WORKING_INPUT_CHEMICAL_PER_ACRE = 'CHEM_PROT_WORKING_INPUT_CHEMICAL_PER_ACRE',
  CHEM_PROT_WORKING_INPUT_WORKING_SOLUTION = 'CHEM_PROT_WORKING_INPUT_WORKING_SOLUTION',
  CHEM_PROT_WORKING_INPUT_SPRAYER_VOLUME = 'CHEM_PROT_WORKING_INPUT_SPRAYER_VOLUME',
  CHEM_PROT_WORKING_INPUT_AREA = 'CHEM_PROT_WORKING_INPUT_AREA',
  CHEM_PROT_WORKING_RESULTS_TITLE = 'CHEM_PROT_WORKING_RESULTS_TITLE',
  CHEM_PROT_WORKING_TOTAL_CHEMICAL = 'CHEM_PROT_WORKING_TOTAL_CHEMICAL',
  CHEM_PROT_WORKING_TOTAL_SOLUTION = 'CHEM_PROT_WORKING_TOTAL_SOLUTION',
  CHEM_PROT_WORKING_SPRAYER_COUNT = 'CHEM_PROT_WORKING_SPRAYER_COUNT',
  CHEM_PROT_WORKING_CHEMICAL_PER_SPRAYER = 'CHEM_PROT_WORKING_CHEMICAL_PER_SPRAYER',
  CHEM_PROT_WORKING_VIZ = 'CHEM_PROT_WORKING_VIZ',
  CHEM_PROT_WORKING_VIZ_GENERAL = 'CHEM_PROT_WORKING_VIZ_GENERAL',
  CHEM_PROT_WORKING_VIZ_ALL_ELEMENTS = 'CHEM_PROT_WORKING_VIZ_ALL_ELEMENTS',
  CHEM_PROT_WORKING_VIZ_ELEMENTS_RELATIONSHIP = 'CHEM_PROT_WORKING_VIZ_ELEMENTS_RELATIONSHIP',
  CHEM_PROT_WORKING_VIZ_COMPARE_CALCED_PARAMS = 'CHEM_PROT_WORKING_VIZ_COMPARE_CALCED_PARAMS',
  CHEM_PROT_WORKING_VIZ_EFFICIENCY = 'CHEM_PROT_WORKING_VIZ_EFFICIENCY',
  CHEM_PROT_WORKING_VIZ_EFFICIENCY_PERCENTAGE = 'CHEM_PROT_WORKING_VIZ_EFFICIENCY_PERCENTAGE',
  CHEM_PROT_WORKING_VIZ_EFFICIENCY_SUGGESTED = 'CHEM_PROT_WORKING_VIZ_EFFICIENCY_SUGGESTED',
  CHEM_PROT_WORKING_CHEMICAL_CONCENTRATION = 'CHEM_PROT_WORKING_CHEMICAL_CONCENTRATION',
  CHEM_PROT_WORKING_SPRAYER_EFFICIENCY = 'CHEM_PROT_WORKING_SPRAYER_EFFICIENCY',
  CHEM_PROT_WORKING_SOLUTION_DISTRIBUTION = 'CHEM_PROT_WORKING_SOLUTION_DISTRIBUTION',
}
...
const LangMap: LangMapInterface = {
  BG: {
    ...
    [SELECTABLE_STRINGS.CHEMICAL_PROTECTION_PERCENT_SOLUTION_CALC_TITLE]:
      'Химическа защита - прицентен разтвор',
    ...
    //chemical protection working solution
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_CALC_TITLE]: 'Работен разтвор',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_CALC_DESCRIPTION]: 'Изчислете количеството работен разтвор за вашата площ',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_INPUT_DESCRIPTION]: 'Въведете стойността за изчисление',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_INPUT_CHEMICAL_PER_ACRE]: 'Химикал на декар',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_INPUT_WORKING_SOLUTION]: 'Работен разтвор на декар',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_INPUT_SPRAYER_VOLUME]: 'Обем на пръскачката на декар',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_INPUT_AREA]: 'Площ за пръскане',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_RESULTS_TITLE]: 'Резултати от изчислението',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_TOTAL_CHEMICAL]: 'Общо количество химикал',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_TOTAL_SOLUTION]: 'Общо количество работен разтвор',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_SPRAYER_COUNT]: 'Брой пръскачки',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_CHEMICAL_PER_SPRAYER]: 'Химикал на пръскачка',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_VIZ]: 'Визуализация на изчислението',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_VIZ_GENERAL]: 'Графично представяне на резултатите',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_VIZ_ALL_ELEMENTS]: 'Обща визуализация на параметрите',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_VIZ_ELEMENTS_RELATIONSHIP]: 'Пропорции между параметрите',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_VIZ_COMPARE_CALCED_PARAMS]: 'Сравнение на изчислените стойности',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_VIZ_EFFICIENCY]: 'Ефективност на приложението',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_VIZ_EFFICIENCY_PERCENTAGE]: 'Ефективност (%)',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_VIZ_EFFICIENCY_SUGGESTED]: '*Стойностите са препоръчителни и могат да варират според конкретните условия',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_CHEMICAL_CONCENTRATION]: 'Концентрация на химикала',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_SPRAYER_EFFICIENCY]: 'Ефективност на пръскачката',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_SOLUTION_DISTRIBUTION]: 'Разпределение на разтвора',
  },
  EN: {
    //plants
    ...
    //chemical protection working solution
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_CALC_TITLE]: 'Working Solution',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_CALC_DESCRIPTION]: 'Calculate the working solution amount for your area',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_INPUT_DESCRIPTION]: 'Enter the value for calculation',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_INPUT_CHEMICAL_PER_ACRE]: 'Chemical per acre',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_INPUT_WORKING_SOLUTION]: 'Working solution per acre',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_INPUT_SPRAYER_VOLUME]: 'Sprayer volume per acre',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_INPUT_AREA]: 'Area to be sprayed',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_RESULTS_TITLE]: 'Calculation Results',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_TOTAL_CHEMICAL]: 'Total chemical amount',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_TOTAL_SOLUTION]: 'Total working solution amount',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_SPRAYER_COUNT]: 'Number of sprayers',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_CHEMICAL_PER_SPRAYER]: 'Chemical per sprayer',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_VIZ]: 'Calculation Visualization',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_VIZ_GENERAL]: 'Graphical representation of the results',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_VIZ_ALL_ELEMENTS]: 'General visualization of parameters',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_VIZ_ELEMENTS_RELATIONSHIP]: 'Proportions between parameters',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_VIZ_COMPARE_CALCED_PARAMS]: 'Comparison of calculated values',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_VIZ_EFFICIENCY]: 'Application Efficiency',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_VIZ_EFFICIENCY_PERCENTAGE]: 'Efficiency (%)',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_VIZ_EFFICIENCY_SUGGESTED]: '*Values are suggested and may vary depending on specific conditions',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_CHEMICAL_CONCENTRATION]: 'Chemical Concentration',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_SPRAYER_EFFICIENCY]: 'Sprayer Efficiency',
    [SELECTABLE_STRINGS.CHEM_PROT_WORKING_SOLUTION_DISTRIBUTION]: 'Solution Distribution',
  },
};
