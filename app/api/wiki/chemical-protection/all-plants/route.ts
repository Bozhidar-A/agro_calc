...
export async function GET() {
    try {
        ...
        Log(["api", "wiki", "chem protection", "all-plants", "route"], `GET returned: ${JSON.stringify(res)}`);
        ...
        Log(["api", "wiki", "chem protection", "all-plants", "route"], `GET failed with: ${errorMessage}`);
