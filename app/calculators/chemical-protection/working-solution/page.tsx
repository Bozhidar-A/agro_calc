...
export default function ChemicalProtectionWorkingSolution() {
  ...
  const { form, onSubmit, dataToBeSaved, CountWarnings, plantsChems, loading, lastUsedPlantId } =
            ...
            <form onSubmit={form.handleSubmit(() => onSubmit())} className="space-y-6 sm:space-y-8">
                ...
                {lastUsedPlant && !form.watch('selectedPlantId') && (
                  <Alert className="mb-4 border-blue-200">
                    ...
                    <AlertDescription className="flex items-center justify-between w-full gap-2">
                      <span>
                        {translator(SELECTABLE_STRINGS.CHEM_PROT_WORKING_SOLUTION_LAST_USED_PLANT)}{' '}
                        - {translator(lastUsedPlant.latinName)}
                      </span>
                      <Button
                        variant="outline"
                        size="sm"
                      ...
                      >
                        <SelectValue
                          placeholder={translator(
                            SELECTABLE_STRINGS.CHEM_PROT_WORKING_SOLUTION_SELECT_PLANT
                          )}
                        />
                      </SelectTrigger>
                      <SelectContent>
                ...
                <div className="space-y-3 sm:space-y-4 flex flex-col items-center">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      ...
                      >
                        <SelectTrigger
                          id="chemicalSelection"
                          className="text-lg sm:text-xl py-4 sm:py-6 w-full max-w-xs"
                        >
                          <SelectValue
                            placeholder={translator(
                              SELECTABLE_STRINGS.CHEM_PROT_WORKING_SOLUTION_SELECT_CHEMICAL
                            )}
                          />
                        </SelectTrigger>
                        <SelectContent>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4 sm:gap-6">
                ...
                <ChemProtWorkingSolutionBuildInputRow
                  ...
                  displayName={translator(
                    SELECTABLE_STRINGS.CHEM_PROT_WORKING_SOLUTION_INPUT_WORKING_SOLUTION
                  )}
                  form={form}
                  icon={<Beaker className="h-5 w-5" />}
                  translator={translator}
                ...
                <ChemProtWorkingSolutionBuildInputRow
                  ...
                  displayName={translator(
                    SELECTABLE_STRINGS.CHEM_PROT_WORKING_SOLUTION_INPUT_SPRAYER_VOLUME
                  )}
                  form={form}
                  icon={<Beaker className="h-5 w-5" />}
                  translator={translator}
                    ...
                    <CardContent className="pt-3 sm:pt-4">
                      <div className="space-y-3 sm:space-y-4">
                        ...
                        <ChemProtWorkingSolutionDisplayOutputRow
                          ...
                          text={translator(
                            SELECTABLE_STRINGS.CHEM_PROT_WORKING_SOLUTION_SPRAYER_COUNT
                          )}
                          unit=""
                          decimals={2}
                        />
