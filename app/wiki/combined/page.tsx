          ...
          <div className="flex flex-col items-center">
            <div className="w-full max-w-2xl space-y-6">
              ...
              <div className="space-y-4">
                {plants.map((plant) => (
                  <Link key={plant.id} href={`/wiki/combined/plant/${plant.id}`} className="block">
