...
describe('SowingCharts', () => {
    ...
    describe('Acres Mode', () => {
        ...
        it('renders all chart sections', () => {
            renderWithRedux(
                () => <SowingCharts data={mockData} />,
                { preloadedState }
            );

            // Check for main sections using translated strings
            expect(screen.getByText(mockTranslateFunction(SELECTABLE_STRINGS.SOWING_RATE_VIZ))).toBeInTheDocument();
            expect(screen.getByText(mockTranslateFunction(SELECTABLE_STRINGS.SOWING_RATE_VIZ_ALL_ELEMENTS))).toBeInTheDocument();
            expect(screen.getByText(mockTranslateFunction(SELECTABLE_STRINGS.SOWING_RATE_VIZ_ELEMENTS_RELATIONSHIP))).toBeInTheDocument();
            expect(screen.getByText(mockTranslateFunction(SELECTABLE_STRINGS.SOWING_RATE_VIZ_COMPARE_CALCED_PARAMS as keyof typeof SELECTABLE_STRINGS))).toBeInTheDocument();
            expect(screen.getByText(mockTranslateFunction(SELECTABLE_STRINGS.SOWING_RATE_VIZ_PLANTING_EFFICIENCY))).toBeInTheDocument();
        });
    ...
    describe('Edge Cases', () => {
        ...
        it('displays correct plant name in description', () => {
            ...
            const plantName = mockTranslateFunction(mockData.plantLatinName as keyof typeof SELECTABLE_STRINGS);
