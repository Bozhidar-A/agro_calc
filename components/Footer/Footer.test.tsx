  ...
  it('renders all navigation links with correct hrefs', () => {
    const expectedLinks = [
      { href: '/', text: translate(SELECTABLE_STRINGS.FOOTER_HOME) },
      {
        ...
        text: translate(SELECTABLE_STRINGS.FOOTER_SOWING_RATE_CALCULATOR),
      },
      {
        href: '/calculators/combined',
        text: translate(SELECTABLE_STRINGS.FOOTER_COMBINED_CALCULATOR),
      },
      {
        href: '/calculators/chemical-protection/working-solution',
        text: translate(SELECTABLE_STRINGS.FOOTER_CHEMICAL_PROTECTION_CALCULATOR),
      },
      {
