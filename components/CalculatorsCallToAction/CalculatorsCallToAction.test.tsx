...
describe('CalculatorsCallToAction', () => {
    ...
    beforeEach(() => {
        ...
        renderWithProviders(<CalculatorsCallToAction />, { preloadedState });
    });
    ...
    it('renders all calculator cards', () => {
        ...
        const workingSolutionCalc = screen.getByText(mockTranslateFunction('CHEM_PROT_WORKING_SOLUTION_CALC_TITLE'));
        const percentSolutionCalc = screen.getByText(mockTranslateFunction('CHEMICAL_PROTECTION_PERCENT_SOLUTION_CALC_TITLE'));
    ...
    it('renders calculator descriptions', () => {
        ...
        const workingSolutionDesc = screen.getByText(mockTranslateFunction('CHEM_PROT_WORKING_SOLUTION_CALC_DESCRIPTION'));
        const percentSolutionDesc = screen.getByText(mockTranslateFunction('CHEMICAL_PROTECTION_CALC_DESCRIPTION'));
    ...
    it('has correct styling classes', () => {
        ...
        expect(grid).toHaveClass('grid', 'grid-cols-1', 'md:grid-cols-2', 'lg:grid-cols-2', 'gap-8', 'sm:gap-10');
    });
}); 