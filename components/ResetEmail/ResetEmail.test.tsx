...
describe('GenerateResetEmailHTML', () => {
  ...
  describe('Reset link handling', () => {
    ...
    it('should handle very long reset links', () => {
      const longLink =
        'https://verylongdomainname.example.com/auth/password-reset/very-long-token-that-might-wrap-in-email-clients?user=test%40example.com&redirect=https%3A%2F%2Fapp.example.com%2Fdashboard';
  ...
  describe('Security considerations', () => {
    ...
    it('should handle HTML entities in reset link', () => {
      const linkWithEntities =
        'https://example.com/reset?token=abc&lt;script&gt;alert()&lt;/script&gt;';
