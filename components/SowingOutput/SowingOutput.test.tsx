...
describe('SowingOutput', () => {
    ...
    it('renders with correct initial values', () => {
        renderWithRedux(
            () => <SowingOutput dataToBeSaved={mockData} />,
            { preloadedState }
        );
        ...
        expect(screen.getByText(mockTranslateFunction(SELECTABLE_STRINGS.SEEDS_PER_M2))).toBeInTheDocument();
        ...
        expect(screen.getByText(mockTranslateFunction(SELECTABLE_STRINGS.SOWING_RATE_THIS_IS_SUGGESTED))).toBeInTheDocument();
    });
    ...
    it('handles different data values correctly', () => {
        ...
        renderWithRedux(
            () => <SowingOutput dataToBeSaved={differentData} />,
            { preloadedState }
        );
