...
describe('SeedCombinedRow', () => {
  ...
  it('renders all form fields correctly', () => {
    renderWithReduxAndForm(
      ({ form }) => <SeedCombinedRow form={form} name="legumes" index={0} dbData={mockDbData} />,
      {
        preloadedState,
  ...
  it('displays plant selection dropdown with correct options', () => {
    ...
    const plant1 = mockTranslateFunction(
      mockDbData[0].latinName as keyof typeof SELECTABLE_STRINGS
    );
    const plant2 = mockTranslateFunction(
      mockDbData[1].latinName as keyof typeof SELECTABLE_STRINGS
    );
