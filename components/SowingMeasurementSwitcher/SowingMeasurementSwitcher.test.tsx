...
describe('SowingMeasurementSwitcher', () => {
  ...
  describe('Acres Mode', () => {
    ...
    it('displays correct values and units for acres', async () => {
      ...
      expect(
        screen.getByText(mockTranslateFunction(SELECTABLE_STRINGS.PLANTS_PER_ACRE))
      ).toBeInTheDocument();
  ...
  describe('Hectares Mode', () => {
    ...
    it('displays correct converted values and units for hectares', async () => {
      ...
      expect(
        screen.getByText(mockTranslateFunction(SELECTABLE_STRINGS.PLANTS_PER_HECTARE))
      ).toBeInTheDocument();
  ...
  describe('Invalid Mode', () => {
    ...
    it('returns null for invalid unit of measurement', async () => {
      ...
      expect(
        screen.queryByText(mockTranslateFunction(SELECTABLE_STRINGS.PLANTS_PER_ACRE))
