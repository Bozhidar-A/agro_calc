...
export function ChemProtWorkingSolutionDisplayOutputRow({ data, text, unit, decimals = 2, base = 10 }: DisplayOutputRowProps) {
    ...
    return (
        <div className="flex justify-between items-center border-b pb-2 sm:pb-3">
            ...
            <div>
                <span className="text-lg sm:text-xl font-bold">{ToFixedNumber(safeValue, decimals, base)}</span>
